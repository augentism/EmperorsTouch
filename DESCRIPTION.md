...
- **23 game hooks** and counting:
  - *Continuous:* Health Level, Peril Level, Poxburster Proximity
    (intensity rises as one closes in) — each scales with its value and
    has a per-toy **Invert** option (e.g. stronger as you get hurt)
  ...
  - *Squad & mission:* Knocked Down, Player Death, Mission Start,
    ...
    "For the Emperor!" cheers (yours and allies')
